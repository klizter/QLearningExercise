...
import gym
from q_learning_max_action import QLearningMaxAction
...
def q_learning_greedy_probability_policy():
    ...
    q_learning = QLearningMaxAction(env.action_space.n, env.observation_space.n, epsilon=0.1, learning_rate=0.1)
    q_learning.read_q_function_dump()
    ...
    for i_episode in range(7000):
        ...
        for t in range(100):
            ...
            # Train algorithm based on dumped Q function
